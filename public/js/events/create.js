      ...
      $.ajax({
        ...
        success: function success(response) {
          if ($.isEmptyObject(response.error)) {
            ...
            renderResponse(response); // alert(response.success);
          } else {
...
function renderResponse(data) {
  if (data.isStored) {
    ...
    document.getElementById('subCategoryAmountLabel').innerHTML = 'Amount'; //     <div class="alert alert-danger print-error-msg" style="display:none">
    //     <ul></ul>
    // </div>
