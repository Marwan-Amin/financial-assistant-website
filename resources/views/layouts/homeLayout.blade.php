...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('UI/homePage/css/open-iconic-bootstrap.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('UI/homePage/css/owl.theme.default.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('UI/homePage/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{asset('UI/homePage/css/jquery.timepicker.css')}}">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="#" class="nav-link">Testemonials</a></li>
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#" class="py-2 d-block">Testemonials</a></li>
