...
class ExpenseSubCategoriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $subCategories = array(
            ...
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Hospitals",'category_id' =>10),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Doctors",'category_id' =>10),


            array( 'sub_category_icon' => 'flaticon-', 'name' => "Gym",'category_id' =>11),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Club Training",'category_id' =>11),

            array( 'sub_category_icon' => 'flaticon-', 'name' => "Diapers",'category_id' =>12),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Baby food",'category_id' =>12),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Toys",'category_id' =>12),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Baby Clothes",'category_id' =>12),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Baby accessories",'category_id' =>12),

            array( 'sub_category_icon' => 'flaticon-', 'name' => "Pet food",'category_id' =>13),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Bed",'category_id' =>13),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Vet",'category_id' =>13),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Pet medicine",'category_id' =>13),

            array( 'sub_category_icon' => 'flaticon-', 'name' => "Makeup",'category_id' =>14),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Shampo",'category_id' =>14),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Lotions",'category_id' =>14),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Perfumes",'category_id' =>14),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Skincare",'category_id' =>14),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Haircare",'category_id' =>14),

            array( 'sub_category_icon' => 'flaticon-', 'name' => "TV",'category_id' =>15),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Mobile Accessories",'category_id' =>15),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Computer Accessories",'category_id' =>15),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Computer components",'category_id' =>15),

            array( 'sub_category_icon' => 'flaticon-', 'name' => "Gift",'category_id' =>16),
            
            array( 'sub_category_icon' => 'flaticon-', 'name' => "travel",'category_id' =>17),

            array( 'sub_category_icon' => 'flaticon-', 'name' => "Courses",'category_id' =>18),
            array( 'sub_category_icon' => 'flaticon-', 'name' => "university feess",'category_id' =>18),
            
            array( 'sub_category_icon' => 'flaticon-', 'name' => "Book",'category_id' =>19),

            array( 'sub_category_icon' => 'flaticon-', 'name' => "Office fees",'category_id' =>20),
